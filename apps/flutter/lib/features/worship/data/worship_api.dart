...
class WorshipApi {
  ...
  Future<Map<String, dynamic>> listSongs({String? search, String? tag, String? key, int page = 1, int limit = 20}) async {
    ...
    final r = await _client.get('/worship/songs', queryParameters: p); return r.data;
  }
  Future<Map<String, dynamic>> getSong(String id) async { final r = await _client.get('/worship/songs/$id'); return r.data; }
  Future<Map<String, dynamic>> createSong(Map<String, dynamic> data) async { final r = await _client.post('/worship/songs', data: data); return r.data; }
  Future<Map<String, dynamic>> updateSong(String id, Map<String, dynamic> data) async { final r = await _client.put('/worship/songs/$id', data: data); return r.data; }
  Future<void> deleteSong(String id) async { await _client.delete('/worship/songs/$id'); }
  Future<Map<String, dynamic>> transposeSong(String id, int semitons) async { final r = await _client.post('/worship/songs/$id/transpose', data: {'semitons': semitons}); return r.data; }
  Future<List<dynamic>> getSongHistory(String id) async { final r = await _client.get('/worship/songs/$id/history'); return r.data as List? ?? []; }
  Future<Map<String, dynamic>> listPlaylists({int page = 1, int limit = 20}) async { final r = await _client.get('/worship/playlists', queryParameters: {'page': page, 'limit': limit}); return r.data; }
  Future<Map<String, dynamic>> getPlaylist(String id) async { final r = await _client.get('/worship/playlists/$id'); return r.data; }
  Future<Map<String, dynamic>> createPlaylist(Map<String, dynamic> data) async { final r = await _client.post('/worship/playlists', data: data); return r.data; }
  Future<Map<String, dynamic>> updatePlaylist(String id, Map<String, dynamic> data) async { final r = await _client.put('/worship/playlists/$id', data: data); return r.data; }
  Future<void> deletePlaylist(String id) async { await _client.delete('/worship/playlists/$id'); }
