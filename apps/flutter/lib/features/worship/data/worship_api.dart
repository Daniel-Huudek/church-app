...
class WorshipApi {
  ...
  Future<Map<String, dynamic>> fetchSong(String url) async {
    final r = await _client.post(ApiConfig.worshipSongsFetch, data: {'url': url});
    return _client.unwrapData(r.data);
  }
