...
export class SongService {
  ...
  async create(data: { title: string; artist?: string; key?: string; bpm?: number; duration?: number; lyrics?: string; chords?: string; capo?: number; youtubeUrl?: string; thumbnail?: string; notes?: string; tags?: string[] }) {
  ...
  async update(id: string, data: Partial<{ title: string; artist: string; key: string; bpm: number; duration: number; lyrics: string; chords: string; capo: number; youtubeUrl: string; thumbnail: string; notes: string; isActive: boolean }>) {
